...
-- telescope
-- There are Josean's. TJ's mappings are in the init.lua file
-- The difference is TJ uses 's' instead of 'f' after the leader
...
-- same idea, but for searching with 'n' and 'N'
